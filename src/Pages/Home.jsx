      ...
      <section>
        <div className='container'>
          <div className='lg:w-[470px] mx-auto'>
            ...
            <p className='text__para text-center'>World class care for everyone. Our health system offers unmatched, expert healthcare.</p>
          </div>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
            <div className='py-[30px] px-5'>
              ...
              <div className='mt-[30px]'>
                ...
                <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>World class care for everyone. Our health system offers unmatched, expert health care. From lab to the clinic. </p>
          ...
          <div className='flex items-center justify-between flex-col lg:flex-row'>
            <div className='xl:w-[670px]'>
              ...
              <ul className="pl-4">
                ...
                <li className="text__para">
                  2. Search your physician here, and contact thier office directly.
                </li>
                <li className="text__para">
                  3. View physician who are accepting new patients, use the online Scheduling tool to select and appropriate time.
                </li>
              </ul>
              <Link to='/'>
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
                ...
                <div className='flex items-center gap-[6px] lg:-[10px] mt-2 lg:mt-[18px]'>
                  <img src={avatar} alt="" />
                  <h4 className='text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] text-headingColor font-[700] '>Wayne Collins</h4>
                </div>
              </div>
            </div>
          </div>
