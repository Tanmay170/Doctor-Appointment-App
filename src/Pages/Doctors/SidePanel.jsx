  ...
  return (
    <div className='shadow-panelShadow p-3 lg:p-5 rounded-md'>
        <div className='flex items-center justify-between'>
            ...
            <span className='text-[16px] leading-7 lg:text-[22px] lg:leading-8 text-headingColor font-bold'>1500 Rupees</span>
        </div>
        <div className='mt-[30px]'>
            ...
            <ul className='mt-3'>
                <li className='flex items-center justify-between mb-2'>
                    ...
                    <p className='text-[15px] leading-6 text-textColor font-semibold'>01:00 PM - 05:00 PM</p>
                </li>
                <li className='flex items-center justify-between mb-2'>
