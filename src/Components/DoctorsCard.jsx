...
const DoctorsCard = ({doctor}) => {
    ...
    const{name, avgRating, totalRating, photo, specialization, totalPatient} = doctor;
    ...
    <div className='p-3 lg:p-5'>
        ...
        <div className='mt-2 lg:mt-4 flex items-center justify-between'>
            ...
            <div className='flex items-center gap-[6px]'>
                <span className='flex items-center gap-[6px] text-[14px] leading-6 lg:text-[16px] font-semibold text-headingColor lg:leading-7'><img src={Star} alt="" />{avgRating}</span>
                <span className='text-[14px] leading-6 lg:text-16px lg:leading-7 font-[400] text-headingColor'>({totalRating})</span>
            </div>
        </div>
        <div className='mt-[18px] lg:mt-5 flex items-center justify-between '>
            <div>
                <h3 className='text-[16px] leading-7 lg:text-[18px] lg:leading-[30px] font-semibold text-headingColor'>+1500{totalPatient} patients</h3>
            </div>
